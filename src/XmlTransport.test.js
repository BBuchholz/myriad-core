...
// TODO: add tests for different types (eg. WxrdBook, AliasLists)
// cuz each will have special cases (like looking for nested
// members and aliases)

// TODO: should throw error if an unexpected root element is
// encountered (should only accept recognized root elements,
// <wxrd>, <wxrdBook>, etc.) this will allow us to know when
// to look for members and aliases
