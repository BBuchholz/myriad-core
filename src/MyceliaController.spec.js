...
test('should extract metadata interspersed with string content', () => {
  ...
  mycelia.watchPrefix('alias');
  mycelia.watchPrefix('tags');
  ...
  // Should return a new Wxrd with a new uuid, parsed values set to
  // relevant metadata in the original wxrd, and “replacesWxrd” set
  // to the uuid of the previous wxrd
